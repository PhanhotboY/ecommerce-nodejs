...
export class ProductController {
  static async createProduct(req: Request, res: Response, next: NextFunction) {
    OK({
      ...
      options: {},
      link: {
        getAllDrafts: { href: '/api/v1/products/drafts?limit=50&skip=0', method: 'GET' },
      },
    });
  }
  ...
  static async getAllPublished(req: Request, res: Response, next: NextFunction) {
  ...
  static async getAllDrafts(req: Request, res: Response, next: NextFunction) {
    const result = await ProductService.getAllDraftProducts({ shop: req.user.userId });
  ...
  static async searchProducts(req: Request, res: Response, next: NextFunction) {
    const result = await ProductService.searchProducts(req.params.search as string);
  ...
  static async destroyProduct(req: Request, res: Response, next: NextFunction) {
    const result = await ProductService.destroyProduct(req.user.userId, req.params.productId);
