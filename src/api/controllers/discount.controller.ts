...
export class DiscountController {
  ...
  static async getApplicableProducts(req: Request, res: Response, next: NextFunction) {
    ...
    const result = await DiscountService.getAllApplicableProducts(code, { limit, page });
  ...
  static async getAllDiscountCodes(req: Request, res: Response, next: NextFunction) {
    const { shopId, limit, page } = req.query as Partial<Record<string, string>>;
    const result = await DiscountService.getAllDiscountCodes(shopId as string, { limit, page });
  ...
  static async patchDiscount(req: Request, res: Response, next: NextFunction) {
    ...
    const result = await patchDiscount[action](req.params.code, req.user.userId);
  ...
  static async deleteDiscount(req: Request, res: Response, next: NextFunction) {
    const result = await DiscountService.deleteDiscount(req.params.code, req.user.userId);
